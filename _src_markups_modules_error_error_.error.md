[corebine-web-templates-core](../README.md) › [Globals](../globals.md) › ["src/markups/modules/error/error"](../modules/_src_markups_modules_error_error_.md) › [Error](_src_markups_modules_error_error_.error.md)
...
* [constructor](_src_markups_modules_error_error_.error.md#constructor)

### Properties

* [context](_src_markups_modules_error_error_.error.md#context)
* [props](_src_markups_modules_error_error_.error.md#readonly-props)
* [refs](_src_markups_modules_error_error_.error.md#refs)
* [state](_src_markups_modules_error_error_.error.md#state)
* [contextType](_src_markups_modules_error_error_.error.md#static-optional-contexttype)

### Methods

* [UNSAFE_componentWillMount](_src_markups_modules_error_error_.error.md#optional-unsafe_componentwillmount)
* [UNSAFE_componentWillReceiveProps](_src_markups_modules_error_error_.error.md#optional-unsafe_componentwillreceiveprops)
* [UNSAFE_componentWillUpdate](_src_markups_modules_error_error_.error.md#optional-unsafe_componentwillupdate)
* [componentDidCatch](_src_markups_modules_error_error_.error.md#optional-componentdidcatch)
* [componentDidMount](_src_markups_modules_error_error_.error.md#optional-componentdidmount)
* [componentDidUpdate](_src_markups_modules_error_error_.error.md#optional-componentdidupdate)
* [componentWillMount](_src_markups_modules_error_error_.error.md#optional-componentwillmount)
* [componentWillReceiveProps](_src_markups_modules_error_error_.error.md#optional-componentwillreceiveprops)
* [componentWillUnmount](_src_markups_modules_error_error_.error.md#optional-componentwillunmount)
* [componentWillUpdate](_src_markups_modules_error_error_.error.md#optional-componentwillupdate)
* [forceUpdate](_src_markups_modules_error_error_.error.md#forceupdate)
* [getSnapshotBeforeUpdate](_src_markups_modules_error_error_.error.md#optional-getsnapshotbeforeupdate)
* [render](_src_markups_modules_error_error_.error.md#render)
* [renderErrorMessageByType](_src_markups_modules_error_error_.error.md#rendererrormessagebytype)
* [renderLink](_src_markups_modules_error_error_.error.md#renderlink)
* [renderStatus](_src_markups_modules_error_error_.error.md#renderstatus)
* [setState](_src_markups_modules_error_error_.error.md#setstate)
* [shouldComponentUpdate](_src_markups_modules_error_error_.error.md#optional-shouldcomponentupdate)

## Constructors

###  constructor

\+ **new Error**(`props`: Readonly‹object› | object): *[Error](_src_markups_modules_error_error_.error.md)*
...
**Returns:** *[Error](_src_markups_modules_error_error_.error.md)*

\+ **new Error**(`props`: object, `context`: any): *[Error](_src_markups_modules_error_error_.error.md)*
...
Defined in src/markups/modules/error/error.js:19

**Returns:** *Element‹›*

___

###  renderErrorMessageByType

▸ **renderErrorMessageByType**(`type`: any): *string*

Defined in src/markups/modules/error/error.js:45
...
Defined in src/markups/modules/error/error.js:56
...
Defined in src/markups/modules/error/error.js:34
