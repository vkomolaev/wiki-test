[corebine-web-templates-core](../README.md) › [Globals](../globals.md) › ["src/scripts/base-module"](../modules/_src_scripts_base_module_.md) › [BaseModule](_src_scripts_base_module_.basemodule.md)
