[corebine-web-templates-core](../README.md) › [Globals](../globals.md) › ["src/scripts/social/accesso"](../modules/_src_scripts_social_accesso_.md) › [Accesso](_src_scripts_social_accesso_.accesso.md)
